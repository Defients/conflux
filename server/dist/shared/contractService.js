...
exports.allObjectivesComplete = allObjectivesComplete;
...
const OBJECTIVE_TEMPLATES = [
    ...
    },
    {
        ...
        generator: (rng, difficulty) => {
            const dimensions = ['reaction', 'typing', 'precision', 'memory', 'rhythm', 'logic'];
...
function generateContracts(seed) {
    const rng = new seededRNG_1.SeededRNG(`contracts-${seed}`);
...
function evaluateContracts(contracts, gameState, eventDimensionMap) {
...
function allObjectivesComplete(contract) {
