 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sr(r){try{return(r.startsWith("http://")||r.startsWith("https://")?new URL(r).hostname:r).endsWith(".cloudworkstations.dev")}catch{return!1}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fo{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(po(n)){const o=n.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(n=>n).join(" ")}}function po(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Pn="@firebase/app",$i="0.14.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const at=new kn("@firebase/app"),go="@firebase/app-compat",mo="@firebase/analytics-compat",yo="@firebase/analytics",_o="@firebase/app-check-compat",wo="@firebase/app-check",vo="@firebase/auth",Io="@firebase/auth-compat",Eo="@firebase/database",Ao="@firebase/data-connect",To="@firebase/database-compat",So="@firebase/functions",bo="@firebase/functions-compat",Co="@firebase/installations",Po="@firebase/installations-compat",No="@firebase/messaging",Ro="@firebase/messaging-compat",Do="@firebase/performance",ko="@firebase/performance-compat",Oo="@firebase/remote-config",Lo="@firebase/remote-config-compat",Mo="@firebase/storage",Uo="@firebase/storage-compat",xo="@firebase/firestore",Vo="@firebase/ai",Fo="@firebase/firestore-compat",jo="firebase",Bo="12.10.0",Ho={[Pn]:"fire-core",[go]:"fire-core-compat",[yo]:"fire-analytics",[mo]:"fire-analytics-compat",[wo]:"fire-app-check",[_o]:"fire-app-check-compat",[vo]:"fire-auth",[Io]:"fire-auth-compat",[Eo]:"fire-rtdb",[Ao]:"fire-data-connect",[To]:"fire-rtdb-compat",[So]:"fire-fn",[bo]:"fire-fn-compat",[Co]:"fire-iid",[Po]:"fire-iid-compat",[No]:"fire-fcm",[Ro]:"fire-fcm-compat",[Do]:"fire-perf",[ko]:"fire-perf-compat",[Oo]:"fire-rc",[Lo]:"fire-rc-compat",[Mo]:"fire-gcs",[Uo]:"fire-gcs-compat",[xo]:"fire-fst",[Fo]:"fire-fst-compat",[Vo]:"fire-vertex","fire-js":"fire-js",[jo]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ea(r){$t(new Ht("platform-logger",e=>new fo(e),"PRIVATE")),$t(new Ht("heartbeat",e=>new Yo(e),"PRIVATE")),wt(Pn,$i,r),wt(Pn,$i,"esm2020"),wt("fire-js","")}ea("");var na="firebase",ia="12.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new pe(5e3,15e3);var nr="@firebase/auth",ir="1.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $e="12.10.0";function ja(r){$e=r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
